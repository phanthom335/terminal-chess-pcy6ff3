    """
    Terminal Chess Pcy6ff3
    ======================
    Open-source Python game project showcasing how to navigate classic mechanics.
    ...
    APP_NAME    = "Terminal Chess Pcy6ff3"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source Python game project showcasing how to navigate classic mechanics.")
